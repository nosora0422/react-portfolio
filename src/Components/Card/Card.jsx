export default function Card({ type, title, description, path, column, skills, onClick }){
    return(
            <div className={`col-span-12 md:col-span-6 md:p-4 ${column} relative bg-white rounded-2xl drop-shadow-md transition-transform transition-filter duration-300 ease-in-out cursor-pointer hover:-translate-x-2 hover:-translate-y-2 hover:drop-shadow-xl`} onClick={onClick}>
